from app import db, EmployeesTable, UserPass, Roles,  Projects, Skills, PersonnelSkills, RequestsProjects, hash_password
...
'''=================================================================================================================='''
'''=================================================================================================================='''
# ADD 19 EMPLOYEES, 4 PROJECT MANAGERS, 2 MANAGERS
...
# the_id = 000002
# the_password = "000002"   # Same as ID but within "...."
...
# the_project_id = 1
# the_skill = "" # First letter must be a capital letter
